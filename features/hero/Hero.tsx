    ...
    <div ref={mainRef} className="bg-white dark:bg-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-start flex flex-col items-center lg:items-start z-10">
            <div className="mb-6 relative">
              <h1 className={`hero-text font-bold ${language === 'en' ? 'text-5xl sm:text-7xl lg:text-8xl tracking-tighter leading-[0.9] font-display' : 'text-4xl sm:text-6xl lg:text-7xl leading-relaxed py-2'}`}>
                {language === 'en' ? (
          ...
          <div className="hero-gallery-wrapper relative w-full h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center will-change-transform">
            ...
            <div className="grid grid-cols-2 gap-4 w-full h-full relative perspective-[1000px]">
              {galleryImages.map((src, index) => (
                <div
                  key={index}
                  className={`hero-gallery-item relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 cursor-pointer group bg-gray-100 dark:bg-zinc-800 hover:z-10 hover:shadow-2xl ${index === 1 ? 'translate-y-8 md:translate-y-12' : index === 2 ? '-translate-y-8 md:-translate-y-12' : ''
                    }`}
                >
                  <ImageReveal
                    src={src}
      ...
      <div className="w-full h-24 sm:h-32 bg-zinc-900 relative z-20 overflow-hidden shadow-2xl skew-y-1 my-8">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <span className={`text-white/90 text-xl sm:text-2xl font-bold tracking-[0.2em] uppercase ${language === 'en' ? 'font-display' : ''} text-shadow-lg drop-shadow-md`}>
      ...
      <div ref={processRef} className="py-24 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className={`text-4xl md:text-5xl font-bold mb-4 ${language === 'en' ? 'tracking-tighter font-display' : ''}`}>{t('home.process.title')}</h2>
      ...
      <div ref={qualityRef} className="py-24 bg-gray-50 dark:bg-zinc-900 border-y border-gray-200 dark:border-zinc-800 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="quality-content order-2 md:order-1">
            <h2 className={`text-4xl md:text-6xl font-bold mb-6 leading-tight ${language === 'en' ? 'tracking-tighter font-display' : ''}`}>
