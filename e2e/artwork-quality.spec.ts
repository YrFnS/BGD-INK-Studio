...
const wideTransparentPng = Buffer.from(
  '',
  'base64',
);
...
test('preserves artwork aspect ratio and reports local print quality', async ({ page }) => {
  ...
  await expect(quality).toContainText('Transparent background · 60%');
