...
export const Preloader: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      timeline.to(progressRef.current, { scaleX: 1, duration: 1.2, ease: 'power2.inOut' }, 0);
      timeline.to(textGroupRef.current, { yPercent: -75, duration: 1.2, ease: 'power4.inOut' }, 0);
