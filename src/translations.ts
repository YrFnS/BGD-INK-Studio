...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    'customizer.addToCart': 'Continue to Draft Details',
    ...
    'checkout.summary': 'Draft Summary',
    ...
    'seo.checkout.title': 'Draft Details | {{brand}}',
    'seo.checkout.description':
      'Add contact and address details to a browser-local apparel design draft. No real order is submitted.',
  ...
  ar: {
    ...
    'hero.subtitle':
      'جهّز مسودة تصميم محلية مع توزيع يناسب الموديل، قياسات واضحة، إرشادات لجودة الصورة، وحفظ قابل للاسترجاع بهذا المتصفح.',
    'hero.cta': 'افتح الستوديو',
    'nav.home': 'الرئيسية',
    'nav.catalog': 'الموديلات',
    'nav.designs': 'تصاميمي',
    'catalog.title': 'اختار قطعة موثوقة للمعاينة',
    'catalog.subtitle':
      'كل القطع المحددة تبقى ظاهرة، بس فقط القطع اللي عدها موديل 3D مطابق ومعتمد تدخل للمحرر.',
    ...
    'customizer.notesPlaceholder': 'مثلاً: مكان التصميم، القياس المفضل، سؤال للإنتاج...',
    'customizer.addToCart': 'كمّل معلومات المسودة',
    'customizer.color': 'اللون',
    'customizer.size': 'القياس',
    'customizer.scale': 'حجم التصميم',
    'customizer.interact': 'افتح المعاينة 3D',
    ...
    'customizer.modelUnavailable':
      'هذا المنتج ما عنده موديل 3D مطابق ومعتمد حالياً. اختار منتج جاهز من الموديلات.',
    'checkout.title': 'معلومات المسودة',
    'checkout.submit': 'احفظ المسودة محلياً',
    'checkout.name': 'الاسم',
    'checkout.phone': 'رقم الموبايل',
    'checkout.area': 'المنطقة',
    'checkout.address': 'العنوان الكامل / أقرب نقطة دالة',
    'checkout.summary': 'ملخص المسودة',
    'checkout.total': 'السعر المحدد',
    ...
    'common.price': 'د.ع',
    'common.scroll': 'تصفح',
    'success.title': 'انحفظت المسودة',
    'success.message':
      'مسودة التصميم محفوظة على هذا الجهاز. ما انرسلت للستوديو وما تعتبر طلب مؤكد.',
    'success.orderId': 'رقم المسودة',
    'success.whatsapp': 'دز المسودة واتساب',
    'success.home': 'العودة للرئيسية',
    'seo.home.title': '{{brand}} | ستوديو تصميم ملابس محلي في بغداد',
    'seo.home.description':
    ...
    'seo.checkout.title': 'معلومات المسودة | {{brand}}',
    'seo.checkout.description':
      'أضف معلومات التواصل والعنوان لمسودة تصميم محفوظة بهذا المتصفح. ما يتم إرسال طلب حقيقي.',
    'home.process.title': 'من القطعة إلى مسودة جاهزة',
    'home.process.step1.title': 'اختار موديل معتمد',
    'home.process.step1.desc': 'فقط القطع اللي عدها موديل 3D حقيقي ومجهز تدخل للمحرر.',
    'home.process.step2.title': 'رتّب وراجع',
    'home.process.step2.desc': 'حرّك، كبّر، دوّر، وراجع السنتيمترات وأبعاد الصورة والـDPI.',
    'home.process.step3.title': 'احفظ أو صدّر',
    'home.process.step3.desc': 'استرجع المسودة محلياً أو نزّل إثبات PNG وملف JSON.',
    'home.quality.title': 'قيس قبل الإنتاج',
    'home.quality.desc':
      'المحرر يعرض القياسات المحددة وإرشادات الجودة، ويوضح بصراحة القياسات اللي بعدها تحتاج تأكيد فعلي.',
    'home.marquee':
