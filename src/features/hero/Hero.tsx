...
export const Hero: React.FC<HeroProps> = ({ onStart }) => {
  ...
  return (
    <div ref={mainRef} className="bg-white dark:bg-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-start flex flex-col items-center lg:items-start z-10">
            <div className="mb-6 relative">
              <h1
                className={`hero-text font-bold ${language === 'en' ? 'text-5xl sm:text-7xl lg:text-8xl tracking-tighter leading-[0.9] font-display' : 'text-4xl sm:text-6xl lg:text-7xl leading-relaxed py-2'}`}
              >
                {language === 'en' ? (
                  <>
                    PRINT
      ...
      <div className="w-full h-24 sm:h-32 bg-zinc-900 relative z-20 overflow-hidden shadow-2xl skew-y-1 my-8">
        <div ref={marqueeRef} className="absolute inset-0 w-[200%] h-full flex">
          {/* Texture Image repeated */}
          <div className="w-1/2 h-full relative">
            <img
              src="/generated/black_cotton_fabric_texture_1769457267734.png"
              alt="Premium Cotton Texture"
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <span
            className={`text-white/90 text-xl sm:text-2xl font-bold tracking-[0.2em] uppercase ${language === 'en' ? 'font-display' : ''} text-shadow-lg drop-shadow-md`}
          >
            {language === 'en' ? '100% PREMIUM COTTON' : 'قطن فاخر ١٠٠٪'}
          </span>
        </div>
      </div>
      ...
      <div ref={processRef} className="py-24 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2
            className={`text-4xl md:text-5xl font-bold mb-4 ${language === 'en' ? 'tracking-tighter font-display' : ''}`}
          >
      ...
      <div
        ref={qualityRef}
        className="py-24 bg-gray-50 dark:bg-zinc-900 border-y border-gray-200 dark:border-zinc-800 overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="quality-content order-2 md:order-1">
            <h2
              className={`text-4xl md:text-6xl font-bold mb-6 leading-tight ${language === 'en' ? 'tracking-tighter font-display' : ''}`}
            >
      ...
      <div ref={reviewsRef} className="py-24 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-2xl font-bold uppercase tracking-widest text-gray-400 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="review-card bg-gray-50 dark:bg-zinc-900 p-8 rounded-2xl border border-gray-200 dark:border-zinc-800 relative hover:border-accent dark:hover:border-accent transition-colors duration-300"
            >
      ...
      <div className="bg-black text-white py-24 text-center">
        <h2
          className={`text-4xl md:text-6xl font-bold mb-8 ${language === 'en' ? 'font-display' : ''}`}
        >
          {t('hero.title')}
        </h2>
