  ...
  const copy =
    language === 'ar'
      ? {
          ...
          model: 'تعذر تحميل موديل القطعة 3D. يمكنك مراجعة موضع الطباعة هنا ثم إعادة المحاولة.',
          retry: 'إعادة تشغيل 3D',
      ...
      : {
          ...
          title: '2D review mode',
          manual: 'The 2D view is active. Your layers and local draft remain fully preserved.',
          unsupported: 'WebGL is unavailable, so the Studio is showing a safe 2D review instead of a broken canvas.',
          lost: 'The 3D preview paused after its WebGL context was lost. Your design remains safe.',
          model: 'The 3D garment could not be loaded. Review placement here, then retry the model.',
          retry: 'Restart 3D',
          surface: 'Print surface',
          noArtwork: 'No visible artwork is placed on this side.',
