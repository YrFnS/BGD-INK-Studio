...
When information is incomplete, the UI states that clearly and keeps the relevant action unavailable.
...
- premium header, mobile navigation, and footer
...
- confirmed production methods
- confirmed production times
- approved size charts
- official contact channels
- policies, care guidance, and frequently asked questions

These should be added only after the business supplies or confirms them.

### Customer journey

- quantity and variant-selection experience
- full size-guide interaction
- printing-method explainer once methods are confirmed
- policy and care pages or panels
- contact and handoff flow once official contact details are configured
- complete Iraqi Arabic editorial review
...
2. Every business claim has an approved source.
3. All bilingual content is reviewed in context.
4. The catalog, editor, draft details, and confirmation journey are touch-first and accessible.
