...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  ...
  ar: {
    'hero.title': 'نطبع رؤيتك',
    'hero.subtitle': 'طباعة ملابس مخصصة عالية الجودة في بغداد. دقة عالية وتوصيل سريع.',
    'hero.cta': 'ابدأ التصميم',
    'nav.home': 'الرئيسية',
    'nav.catalog': 'الكتالوج',
    'catalog.title': 'اختر الموديل',
    'catalog.subtitle': 'اختر القماش المناسب لإبداعك. أقطان فاخرة مناسبة لأجواء بغداد.',
    'catalog.startDesign': 'تخصيص',
    'catalog.soldOut': 'نفذت الكمية',
    'product.classic_tshirt': 'تيشيرت كلاسيك',
    'product.premium_hoodie': 'هودي فاخر',
    'product.urban_vest': 'سترة عصرية',
    'product.oversized_tee': 'تيشيرت واسع',
    'customizer.upload': 'رفع التصميم',
    'customizer.change': 'تغيير الصورة',
    'customizer.remove': 'حذف',
    'customizer.notes': 'تعليمات خاصة',
    'customizer.notesPlaceholder': 'مثلاً: الطباعة على الظهر، تصغير الشعار...',
    'customizer.addToCart': 'إكمال الطلب',
    'customizer.color': 'اللون',
    'customizer.size': 'القياس',
    'customizer.scale': 'حجم الشعار',
    'customizer.interact': 'اضغط للمشاهدة 3D',
    'customizer.exitInteract': 'قفل المشاهدة',
    'checkout.title': 'تفاصيل التوصيل',
    'checkout.submit': 'تأكيد الطلب',
    'checkout.name': 'الاسم الكامل',
    'checkout.phone': 'رقم الهاتف (07...)',
    'checkout.area': 'المنطقة / الحي',
    'checkout.address': 'الشارع / الدار / اقرب نقطة دالة',
    ...
    'error.min': 'النص قصير جداً',
    'common.back': 'رجوع',
    'common.price': 'د.ع',
    'common.scroll': 'تصفح',
    'success.title': 'تم استلام الطلب',
    'success.message': 'شكراً لك. تم استلام طلبك. يرجى إرسال التفاصيل عبر الواتساب لتأكيد التصميم.',
    'success.orderId': 'رقم الطلب',
    'success.whatsapp': 'إرسال عبر الواتساب',
    'success.home': 'العودة للرئيسية',
    'seo.home.title': 'ASHUS | طباعة على الملابس في بغداد',
    'seo.home.description': 'أفضل خدمة طباعة تيشيرتات وهوديز في بغداد. جودة عالية وتصاميم مخصصة حسب الطلب. توصيل سريع لكل مناطق بغداد.',
    'seo.catalog.title': 'كتالوج المنتجات | ASHUS للطباعة',
    'seo.catalog.description': 'اختر من تشكيلتنا المميزة من التيشيرتات والهوديز الجاهزة للطباعة. خامات قطنية عالية الجودة تناسب أجواء العراق.',
    'seo.customizer.title': 'صمم ملابسك بنفسك | ASHUS',
    'seo.customizer.description': 'أداة تصميم ثلاثية الأبعاد. ارفع صورتك وشاهدها على الملابس مباشرة. صمم تيشيرت خاص بك الآن.',
    'seo.checkout.title': 'إتمام الطلب | ASHUS',
    'seo.checkout.description': 'أكمل طلبك للحصول على ملابس مطبوعة مخصصة في بغداد.',
    
    // New Sections
    'home.process.title': 'كيف نعمل',
    'home.process.step1.title': 'اختر القطعة',
    'home.process.step1.desc': 'اختر من تشكيلتنا المميزة من التيشيرتات والهوديز القطنية.',
    'home.process.step2.title': 'ارفع وصمم',
    'home.process.step2.desc': 'ارفع تصميمك وشاهد النتيجة مباشرة بتقنية ثلاثية الأبعاد.',
    'home.process.step3.title': 'طباعة وتوصيل',
    'home.process.step3.desc': 'نقوم بالطباعة بأحدث التقنيات والتوصيل لباب بيتك في بغداد.',
    'home.quality.title': 'جودة تدوم',
    'home.quality.desc': 'نستخدم قطن ممشط 100% يتحمل أجواء العراق. طباعتنا مقاومة للغسل ولا تتقشر.',
    'home.reviews.title': 'ثقة العملاء',
    'home.reviews.1': '"دقة الطباعة خرافية. المعاينة 3D ساعدتني جداً في اختيار حجم اللوجو."',
    'home.reviews.2': '"أخيراً براند محلي يوفر خامات ثقيلة ومرتبة. طلبت 5 هوديز للفريق."',
